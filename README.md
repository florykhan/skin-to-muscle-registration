...
![Smoothness versus anatomical safety](assets/figures/smoothness_vs_safety.png)
...
```
assets/figures/initial_mesh.png
```
...
```
assets/figures/target_mesh.png
```
...
![Registered skin mesh before cleanup](assets/figures/registered_skin_mesh.png)

Front, left and right views of the registered skin. The small yellow specks on the jaw and chin are fat showing through closed skin; the large yellow and red areas at the back and top lie behind the open cap boundary and are not defects.

```
assets/figures/registered_skin_mesh.png
```
...
![M5 artifact detection](assets/figures/artifact_detection_m5.png)

M5 selections (yellow dots) from two recorded runs: front, left and bottom views.

```
assets/figures/artifact_detection_m5.png
```
...
![Roughness heatmaps](assets/figures/roughness_heatmaps.png)

Umbrella roughness before cleanup, after the pure Laplacian, after the blocked Laplacian (offline reproduction) and in the saved final scene.

```
assets/figures/roughness_heatmaps.png
```
...
![Skin before and after manual finishing](assets/figures/cleaned_skin_mesh.png)

Skin before the manual finishing pass (left) and in the saved final state (right). The two views use different cameras.

```
assets/figures/cleaned_skin_mesh.png
```
